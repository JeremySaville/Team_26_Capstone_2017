...
function toggleSignIn() {
    if (firebase.auth().currentUser) {
        ...
        var email = document.getElementById('email').value + "@diabetesarp.com";
...
function initApp() {
    ...
    firebase.auth().onAuthStateChanged(function (user) {
        ...
        if (user) {
            ...
            // [START_EXCLUDE]
            if (user.email == 'administrator@diabetesarp.com') {
                ...
                window.alert('That is not an admin account')
                firebase.auth().signOut();
            }
        } else {
            // User is signed out.
    ...
    //document.getElementById('admin').addEventListener('click', function () { window.location = 'adminloginPage.html'; });
